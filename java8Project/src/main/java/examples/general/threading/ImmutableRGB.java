 ...
 * --- Never store references to external, mutable objects passed to the constructor; if necessary, create copies, and
 * store references to the copies. 
 * --- Similarly, create copies of your internal mutable objects when necessary to avoid returning the originals in your
 * methods.
 * 
 * @author daghan
 *
